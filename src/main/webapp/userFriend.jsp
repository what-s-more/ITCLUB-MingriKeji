		...
		<div id="m-container" class="container">
			...
			<div id="content" class="clearfix">
				...
				<div class="main">
					...
					<h2 class="title">
						<a class="slow" title="好友列表">好友列表</a><span class="edit"></span>
					</h2>
					<style>
					.friendIcon{
					...
					<c:set var="friendList" value="${requestScope.friendList}"/>
								...
								<div style="margin-top: 10px">
									<div class="friendIcon"
										...
										<img style="display: inline"
											src="images/ico/${friend.userIco}"
											style="width: 200px;">
										<div style="font-size: 20px; text-align: center">
											<a href="goBlogIndex?master=${friend.id}">${friend.userBlogName}</a>
											<span class="delFlag" style="display:none"><a href="friend?id=${friend.id}&action=delete&master=${master.id}" style="color:red">[删除]</a></span>
										</div>
									</div>
								</div>
							</c:forEach>
