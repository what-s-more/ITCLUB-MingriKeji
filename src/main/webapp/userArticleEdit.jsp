...
<html>
	...
	<c:set var="master" value="${sessionScope.callBlogMaster}"/>
		...
		<div id="m-container" class="container">
			...
			<c:set var="articlesingle" value="${requestScope.articlesingle}"/>
			...
			<div id="content" class="clearfix">
				...
				<div class="main">
					...
					<div id="comments">
						...
						<div  class="respond">
							<form method="post" action="article?type=update&action=modify" >
								
								<div id="author_info" class="ui form">
									<div class="ui three fields">
										<div class="field">
											<input type="text" name="title"  class="text" value="${articlesingle.artTitle}"
...
#reback {
	...
	-ms-border-radius: 2px;
								...
								<input type="hidden" name="id" value="${articlesingle.id}" />
								<div id="author_textarea" >
									<div tabindex="4">
									<textarea style="height:auto" name="content"  rows="20" >${articlesingle.initArtContent}</textarea>
									</div>
									<div id="author_footer" class="clearfix">
									
									<div id="submit-button">
											<input id="reback" onClick="goHistory();" type="button" value="返回"
												class="submit"/>
									</div>
									<div id="submit-button">
