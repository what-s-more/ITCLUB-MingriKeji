			...
			<div class="cbl-logo">
				<div class="cbl-logo-info">
					...
					<div class="cbl-logo-like">
						...
						<a href="building.jsp" class="favorite" style="margin-left:10px;">
					        <span class="c-like-text">修改个人资料</span>
					    </a>
					</div>
								...
								<li>
									<a
										...
										<img alt=""
											...
											<span
										class="muted">${topUser.userName}</span> <span style="float:right">阅读：${topUser.userHitNum}次</span> 
									</a>
								</li>
							</ul>
						</c:forEach>
			...
			<div id="content" class="clearfix">
				...
				<div class="main">
					<article id="post-1372"
						class="post-1372 post type-post status-publish format-standard hentry category-wordpress post-article">
					<h2 class="title">
						<a class="slow" style="color:#24806B">博客名称：${master.userBlogName}</a>
					</h2>
					<h2 class="title">
						<a class="slow" style="color:#24806B">个性签名：${master.userMotto}</a>
					</h2>
					<h2 class="title">
						<a class="slow" style="color:#24806B">创建时间： ${master.userCTTime}</a>
					</h2>
					<h2 class="title">
						<a class="slow" style="color:#24806B">访问次数： ${master.userHitNum}次</a>
					</h2>
...
/* <![CDATA[ */
var fashao = {
	"url" : "http:\/\/guimeng.sinaapp.com\/wp-content\/themes\/unforget",
	"ajaxurl" : "http:\/\/guimeng.sinaapp.com\/",
	"postid" : "1422"
};
/* ]]> */
</script>
